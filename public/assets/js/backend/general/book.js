define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'general/book/index',
                    add_url: 'general/book/add',
                    edit_url: 'general/book/edit',
                    del_url: 'general/book/del',
                    multi_url: 'general/book/multi',
                    table: 'book',
                }
            });
