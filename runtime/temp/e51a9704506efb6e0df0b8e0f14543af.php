<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"E:\phpStudy\PHPTutorial\WWW\fastadmin1\public/../application/admin\view\cate\edit.html";i:1587394099;s:81:"E:\phpStudy\PHPTutorial\WWW\fastadmin1\application\admin\view\layout\default.html";i:1583049507;s:78:"E:\phpStudy\PHPTutorial\WWW\fastadmin1\application\admin\view\common\meta.html";i:1583049507;s:80:"E:\phpStudy\PHPTutorial\WWW\fastadmin1\application\admin\view\common\script.html";i:1583049507;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-weigh" class="control-label col-xs-12 col-sm-2"><?php echo __('Hr'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-weigh" class="form-control" name="row[weigh]" type="text" value="<?php echo $row['hr']; ?>">
        </div>
    </div>    
    <div class="form-group">
